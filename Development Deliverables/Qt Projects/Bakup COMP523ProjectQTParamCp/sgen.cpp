...
//constructor
SGen:: SGen(map<std::pair<QString,QString>,QString> & hmap, QString & filename):hmap(hmap), filename(filename){
...
void SGen::genIncludes(ofstream & savestream) {
...
//generates fields
void SGen::genField(ofstream & savestream){
...
void SGen::genMethod() {
    ...
    genSavetoXMLMethod(it, tab_index);
}

//generate each line of method, indented. Also, puts ; at end. Default is one tab
void SGen::genMethodLine(string s,int tab_amount) {
...
void SGen::genSavetoXMLMethod(map<std::pair<QString,QString>,QString>::const_iterator & it, int tab_index) {
